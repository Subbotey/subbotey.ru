  ...
  return (function (modules) {
                  ...
                  return (
                    ...
                    (function (t, e, r) {
                          ...
                          if (e) {
                            ...
                            var r = this.control.getIndexByValue(
                              ...
                              o = this.control.parseValue(
                                this.control.getValueByIndex(n)
                              );
                            this.isCrossDot(o),
                      ...
                      },
                      {
                        ...
                        get: function () {
                          return B(
                            (this.isHorizontal ? this.height : this.width) || 4
                          );
                        },
                      },
                      {
      ...
      function addStylesClient(parentId, list, _isProduction, _options) {
        ...
        return (
          ...
          function (newList) {
            ...
            newList
              ? addStylesToDom((styles = listToStyles(parentId, newList)))
              : (styles = []);
    ...
    "./src/Header.vue": function (
                  ...
                  "button",
                  {
                    ...
                    on: {
                      click: function ($event) {
                        return (
                          $event.preventDefault(), _vm.recenterPosition($event)
                        );
                      },
                    },
                  },
      ...
      var vue_slider_component_umd_min = __webpack_require__(
        ...
        vue_slider_component_umd_min_default = __webpack_require__.n(
          vue_slider_component_umd_min
        ),
            ...
            return _c("label", { class: _vm.classObject }, [
              _vm.shouldShowLabel
                ? _c("span", { staticClass: "vue-switcher__label" }, [
                    ...
                    !_vm.label && _vm.value
                      ? _c("span", {
                          domProps: { textContent: _vm._s(_vm.textEnabled) },
                        })
                      : _vm._e(),
                    _vm._v(" "),
                    _vm.label || _vm.value
      ...
      var Header_component = normalizeComponent(
        {
          ...
          created() {
            (this.localScale = this.root.state.options.times.timeZoom),
              ...
              (this.style = this.root.mergeDeep(
                {},
                defaultStyle,
                this.dynamicStyle
              )),
              (this.opts = this.root.mergeDeep(
                {},
                defaultOptions,
                this.options
              ));
